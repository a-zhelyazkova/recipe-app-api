...
def detail_url(recipe_id):
    """Create and return a recepi detail url"""
...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        """Rest auth is required to call API"""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        """Test changing the user for the recipe results in an error"""
        new_user = create_user(email='user2@example.com', password='123')
    ...
    def test_recipe_other_users_recipes_error(self):
